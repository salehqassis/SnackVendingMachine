...
import com.freightos.SnackVendingMachine.payment.NotesPayment;
import com.freightos.SnackVendingMachine.payment.CardPayment;
import com.freightos.SnackVendingMachine.payment.CoinPayment;
import com.freightos.SnackVendingMachine.payment.Payment;;
...
//choose payment method
		...
		case 1:
			payment = new CoinPayment(); //payed using coins
		...
		case 2:
			payment = new CardPayment(); //payed using credit card 
			payment.insertMoney(item.getPrice());
			dispenceItem(item);
...
// drop the product for the customer 
