...
//no change since credit card pays exactly the amount needed
	}
	...
	//	should check credit card and if it contains the money here 
		// for lack of time i couldn't implement a sandbox account to test credit cards 
		//and if they have enough money to buy so assuming it all works
		return true;
	}
